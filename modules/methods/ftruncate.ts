...
export default function ftruncate(this: any, fd: number, len?: number): Promise<NodeJS.ErrnoException | void> {
    /*|{
    ...
    return _fsHelper.apply(this, ['ftruncate', ...arguments as any]) as any;
}