...
export default function lchmod(this: any, path: string, mode: string | number): Promise<NodeJS.ErrnoException | void> {
    /*|{
    ...
    return _fsHelper.apply(this, ['lchmod', ...arguments as any]) as any;
}