...
export default function utimes(path: string, atime: string | number | Date, mtime: string | number | Date): Promise<NodeJS.ErrnoException | void> {
    /*|{
    ...
    return _fsHelper.apply(this, ['utimes', ...arguments as any]);
}