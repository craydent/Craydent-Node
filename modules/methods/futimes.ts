...
export default function futimes(this: any, fd: number, atime: string | number | Date, mtime: string | number | Date): Promise<NodeJS.ErrnoException | void> {
    /*|{
    ...
    return _fsHelper.apply(this, ['futimes', ...arguments as any]) as any;
}