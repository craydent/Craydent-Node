...
try {
    ...
    **/
    ...
    JSZip = function (this: any, compression?: string) {
        ...
        if (!(JSZip as any).compressions[this.compression]) {
    ...
    JSZip.prototype.file = function (name: any, data: any, o: any) {
        ...
        if (o.base64 === true) data = (JSZipBase64 as any).decode(data);
        // decode UTF-8 strings if we are dealing with text data
        if (o.binary === false) data = this.utf8encode(data);


        let compression = (JSZip as any).compressions[this.compression];
     ...
     */
    JSZip.prototype.folder = function (name: string): typeof JSZip {
    ...
    JSZip.prototype.remove = function (name: any) {
        ...
        if (file) {
            if (name.match("/") === null) {
                ...
                // folder
                let kids = this.find(new RegExp("^" + name));
    ...
    JSZip.prototype.generate = function (asBytes: any) {
        ...
        return (asBytes) ? zip : (JSZipBase64 as any).encode(zip);
