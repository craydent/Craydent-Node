...
export default function open(this: any, path: string, flags: string | number, mode?: string | number): Promise<NodeJS.ErrnoException | number> {
    /*|{
    ...
    return _fsHelper.apply(this, ['open', ...arguments as any]) as any;
}