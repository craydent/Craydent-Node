...
async function start(prefix) {
    console.log(CONSOLE_COLORS.GREEN, 'copying ignore file');
    var root = require.resolve('../package.json').replace('/package.json', '');
    await _cli_exec(`cp -R  '${root}/.npmignore' '${root}/compiled/.npmignore'`);
    console.log(CONSOLE_COLORS.GREEN, 'finished copying ignore file')
