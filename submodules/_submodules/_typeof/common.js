...
var info = require('./package.json'),
    _craydent_version = info.version, $s = {}, scope = { eval: eval };
global.$g = global;
...
function duplicate(obj, original, recursive/*, ref, current_path, exec*/) {
    try {
        ...
        var loop_func = function (prop, original) { // 0 => property, 1 => original object, 2 => reference path object, 3 => current path, 4 => command object
            if (original.hasOwnProperty(prop) && original[prop] && recursive) {
                ...
                if (typeof(original[prop]) in {"object":1,"function":1} && recursive) {
                    ...
                    return duplicate(obj[prop], original[prop], true, ref, new_path, arguments[argIndex+1]);
                }
...
module.exports.getFuncArgs = getFuncArgs;
module.exports.getFuncName = getFuncName;
module.exports.getProperty = getProperty;
module.exports.indexOf = indexOf;
module.exports.indexOfAlt = indexOfAlt;
module.exports.info = info;
module.exports.merge = merge;
module.exports.parseRaw = parseRaw;
module.exports.replace_all = replace_all;
module.exports.setProperty = setProperty;
module.exports.strip = strip;
module.exports.suid = suid;
module.exports.syncroit = syncroit;
module.exports.general_trim = general_trim;
