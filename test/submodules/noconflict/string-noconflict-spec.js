...
require.cache[require.resolve(pre + 'craydent-array/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-array/noConflict.js')];
var $c = require(pre + 'craydent-string/noConflict.js');
$c.DEBUG_MODE = true;
