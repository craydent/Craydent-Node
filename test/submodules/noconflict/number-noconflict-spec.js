...
require.cache[require.resolve(pre + 'craydent-number/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-number/noConflict.js')];
var $c = require(pre + 'craydent-number/noConflict.js');
$c.DEBUG_MODE = true;
