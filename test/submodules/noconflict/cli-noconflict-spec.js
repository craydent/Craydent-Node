...
require.cache[require.resolve(pre + 'craydent-cli/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-cli/noConflict.js')];
var $c = require(pre + 'craydent-cli/noConflict.js');
$c.DEBUG_MODE = true;
