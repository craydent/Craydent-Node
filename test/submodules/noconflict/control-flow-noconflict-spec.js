...
require.cache[require.resolve(pre + 'craydent-control-flow/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-control-flow/noConflict.js')];
var $c = require(pre + 'craydent-control-flow/noConflict.js');
$c.DEBUG_MODE = true;
