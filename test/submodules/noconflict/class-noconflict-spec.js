...
require.cache[require.resolve(pre + 'craydent-class/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-class/noConflict.js')];
var $c = require(pre + 'craydent-class/noConflict.js');
$c.DEBUG_MODE = true;
