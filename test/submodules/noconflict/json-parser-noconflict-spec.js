...
require.cache[require.resolve(pre + 'craydent-json-parser/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-json-parser/noConflict.js')];
var $c = require(pre + 'craydent-json-parser/noConflict.js');
$c.DEBUG_MODE = true;
