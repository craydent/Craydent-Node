...
require.cache[require.resolve(pre + 'craydent-http/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-http/noConflict.js')];
var $c = require(pre + 'craydent-http/noConflict.js');
$c.DEBUG_MODE = true;
