...
require.cache[require.resolve(pre + 'craydent-regexp/noConflict.js')] && delete require.cache[require.resolve(pre + 'craydent-regexp/noConflict.js')];
var $c = require(pre + 'craydent-regexp/noConflict.js');
$c.DEBUG_MODE = true;
