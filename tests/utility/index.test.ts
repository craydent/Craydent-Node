...
describe('No Conflict Global methods', function () {
    ...
    it('ajax error', function () {
        var errored = false, prm1 = $c.ajax({
            ...
            onerror: function (data: any, req: any, ctx, status_code: any) {
                expect(status_code).toBe(404);
                expect(errored).toBe(false);
                errored = true;
            }
        });
        (prm1 as any).otherwise(function (this: any, data: any, req: any, ctx: any, status_code: any) {
            expect(status_code).toBe(404);
    ...
    it('ajax - hitch', function () {
        ...
        prm2.then(function (this: any, data: any, req: any, ctx: any, status_code: any) {
            expect(stage++).toBe(3);
            expect(data).toEqual(usersdata);
            expect(ctx).toBe(ctx);
            expect(status_code).toBe(200);
