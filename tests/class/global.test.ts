import $c from '../../compiled/transformedMajor/class/global';
...
describe('No Conflict Global classes', function () {
    ...
    it('OrderedList - object', function () {
        var ol = new OrderedList(oarr, function (a, b) { if (a.p < b.p) { return -1; } if (a.p > b.p) { return 1; } return 0; });
        // expect(ol.hasNext()).toBe(true);
