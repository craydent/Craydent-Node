import $c from '../../compiled/transformedMajor/string/global';
...
describe('No Conflict String', function () {
  ...
  it('cut', function () {
    expect("cala".cut(1, 2)).toBe("ca");
    expect("cala".cut(1, 2, "p")).toBe("cpa");
  });
  it('ellipsis', function () {
    expect("calasdfadfasdfasdfadf".ellipsis(1)).toBe("c...");
  ...
  it('highlight', function () {
    ...
    expect("cal".highlight(/a/, 'chl')).toBe("c<span class=\"chl\">a</span>l");
    expect("cal".highlight('a', null as any, 'div')).toBe("c<div class=\"chighlight\">a</div>l");
    expect("cal".highlight(/a/, null as any, 'div')).toBe("c<div class=\"chighlight\">a</div>l");
  ...
  it('startsWithAny', function () {
    ...
    expect("pull".startsWithAny("build", "pull", "npm")).toBe("pull");
  });
  it('strip', function () {
